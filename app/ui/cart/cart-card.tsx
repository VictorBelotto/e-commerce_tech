		...
		<main className="flex w-full py-2 px-2 text-white">
			...
			<div className="flex w-full ml-4 items-center justify-between">
				<div className="flex-col w-full max-w-[500px] flex h-full">
					<p className="w-full h-full font-semibold text-wrap line-clamp-2 truncate">
						{name}
					</p>
					<div className="mt-auto flex flex-col line text-gray-300">
						<p className="text-sm">
							Com desconto no PIX: {formatCurrencyBRL(price)}
						</p>
						<p className="text-sm max-w-72">
							Parcelado no cartão de crédito em até 10x sem juros de:{" "}
							{valorParcelado}
						</p>
					</div>
				</div>
				...
				<div className="flex flex-col gap-2 h-full items-end">
					...
					{/* tem uma tag a sem href */}
					<a className="text-lg font-semibold text-orange-500">
